...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2 class="h4 fw-bold mb-1">Form Tambah User</h2>
        <p class="text-muted mb-0" style="font-size: 14px;">Buat akun baru untuk admin atau siswa yang dapat mengakses sistem</p>
    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="username" class="form-control border-start-0 ps-0 @error('username') is-invalid @enderror"
                            value="{{ old('username') }}" placeholder="Contoh: user123" required>
                    </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="email" name="email" class="form-control border-start-0 ps-0 @error('email') is-invalid @enderror"
                        value="{{ old('email') }}" placeholder="Contoh: user@email.com" required>
                </div>
